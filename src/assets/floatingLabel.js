  ...
  ;(function ( $, window, document, undefined ) {
          ...
          var pluginName = "floatlabel",
              defaults = {
                  ...
                  labelClass                      : '',
                  typeMatches                     : /text|password|email|number|search|url|date/
              };
          ...
          Plugin.prototype = {
              ...
              init: function () {
                  ...
                  if( this.$element.prop('tagName').toUpperCase() != 'INPUT' && this.$element.prop('tagName').toUpperCase() != 'SELECT' ) return;
  
                  if( !this.settings.typeMatches.test( this.$element.attr('type') ) && this.$element.prop('tagName').toUpperCase() != 'SELECT' ) return;
              ...
              checkValue: function( e ) {
                  ...
                  if( this.$element.val() != "" && this.$element.val() != this.$element.attr('placeholder') ) this.$element.data('flout', '1');
